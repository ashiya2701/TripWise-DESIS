...
def sampleCheckData():
    ...
    data2=[
        ['Delhi','Chandigarh',35,2999],
        ['Delhi','Mumbai',60,8999],
        ['Delhi','Hyderabad',86,3599],
        ['Delhi','Banglore',65,3599],
        ['Delhi','Kolkata',40,2599],
        ['Delhi','Guwahati',140,2599],
        ['Delhi','Surat',55,3599],
        ['Delhi','Ahemdabad',55,4599],
        ['Delhi','Patna',35,3599],
        ['Delhi','Jaipur',105,3599],
        ['Delhi','Ranchi',55,2599],
        ['Delhi','Indore',60,2999],
        ['Delhi','Pune',55,4999],
        ['Delhi','Panaji',55,5999],
        ['Delhi','Bhubaneshwar',45,2999],
        ['Delhi','Tiruchirapalli',100,3549],
        ['Delhi','Chennai',100,2999],
        ['Mumbai','Kolkata',50,4999],
        ['Mumbai','Hyderabad',35,2999],
        ['Mumbai','Banglore',35,3299],
        ['Mumbai','Chandigarh',100,3999],
        ['Mumbai','Chennai',45,2999],
        ['Mumbai','Surat',125,3999],
        ['Mumbai','Patna',100,2999],
        ['Mumbai','Ahemdabad',100,4999],
        ['Mumbai','Jaipur',120,6999],
        ['Mumbai','Pune',25,1999],
        ['Mumbai','Ranchi',60,4999],
        ['Mumbai','Panaji',25,5999],
        ['Mumbai','Guwahati',90,3999],
        ['Mumbai','Indore',55,3005],
        ['Mumbai','Delhi',50,3999],
        ['Hyderabad','Delhi',50,3999],
        ['Hyderabad','Kolkata',120,4999],
        ['Hyderabad','Mumbai',35,2999],
        ['Hyderabad','Banglore',25,2299],
        ['Hyderabad','Chennai',25,2999],
        ['Hyderabad','Surat',25,3999],
        ['Hyderabad','Pune',25,1999],
        ['Hyderabad','Tiruchirapalli',40,2549],
        ['Banglore','Delhi',60,3999],
        ['Banglore','Kolkata',120,4999],
        ['Banglore','Mumbai',35,2999],
        ['Banglore','Hyderabad',25,2299],
        ['Banglore','Chennai',25,2999],
        ['Banglore','Surat',125,3999],
        ['Banglore','Pune',25,1999],
        ['Banglore','Tiruchirapalli',40,2549],
        ['Chennai','Delhi',60,3999],
        ['Chennai','Kolkata',90,4999],
        ['Chennai','Mumbai',35,2999],
        ['Chennai','Hyderabad',25,2299],
        ['Chennai','Banglore',25,2999],
        ['Chennai','Surat',125,3999],
        ['Chennai','Pune',25,1999]
